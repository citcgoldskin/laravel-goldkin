...
@section('content')
    <div id="contents">
        @include('admin.layouts.header_under', ['action_url'=>route('admin.freq.question.detail', ['question'=>$question->que_id])])
            ...
            <section>
                <div id="main-contents">
                    <div class="search-result-area">
                        ...
                        <div class="btn mtb">
                            <button type="submit" onclick="location.href=''" class="draft" id="btn_draft">下書きとして保存する</button>
                        </div>
                    </div>
                </div>
            </section>
