...
@section('content')
    <div id="contents">
        ...
        {{ Form::open(["route"=>"admin.freq.reserve_question.doReserveQuestionUpdate", "method"=>"post", "name"=>"frm_reserve_question", "id"=>"frm_reserve_question"]) }}
            ...
            <section>
                <div id="main-contents">
                    <div class="search-result-area">
                        ...
                        @enderror
                        <div class="btn mtb">
                            <button type="submit" class="pubric" id="btn_update">内容変更を確定する</button>
                        </div>
                        <div class="btn mtb">
                            <button type="button" class="reserve" id="btn_back">戻る</button>
                        </div>
                    </div>
                </div>
            </section>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#btn_back').click(function(e) {
                e.preventDefault();
                location.href='{{ route('admin.freq.reserve_question.edit', ['question'=>$question->que_id, 'reserve_type'=>$reserve_type]) }}';
            });
        });
    </script>
@endsection
