...
@section('content')
    <div id="contents">
        ...
        {{ Form::open(["route"=>"admin.freq.sub_category.destroy_category", "method"=>"post", "name"=>"frm_destroy_category", "id"=>"frm_destroy_category"]) }}
            ...
            <section>
                ...
                <div id="main-contents">
                    <div class="search-result-area">
                        ...
                        <div class="hidden">
                            <div class="btn mtb">
                                <button class="add btn_complete" onclick="location.href='{{ route('admin.freq.sub_category.index', ['category'=>$category_id]) }}'">完了する</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        @include('admin.layouts.modal-layout', [
            ...
            'modal_title'=>"サブカテゴリーを削除してもよろしいですか？",
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.btn_complete').click(function(e) {
                e.preventDefault();
                location.href = "{{ route('admin.freq.sub_category.index', ['category'=>$category_id]) }}";
            });
