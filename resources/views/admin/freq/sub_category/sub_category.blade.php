...
@section('content')
    <div id="contents">
        ...
        <div class="tabs form_page">
            <label class="page-title" style="width: 100%;">{{ $obj_category->qc_name }}</label>
                ...
                <form method="GET" action="" accept-charset="UTF-8" name="form1" id="form1">
                    <div id="main-contents">
                        <div class="search-result-area">
                            <table class="total">
                                <tr>
                                    <td class="text-left pb-0"><button type="button" class="new half" onclick="location.href='{{ route('admin.freq.sub_category.new') }}'">新規追加</button></td>
                                    <td class="pb-0"><button type="button" class="edit half" onclick="location.href='q6-sort-sub.php'">並び替え</button></td>
                                </tr>
                                <tr>
                                    <td class="text-left"><button type="button" class="delete2 half" onclick="location.href='q6-delete-sub.php'">削除</button></td>
                                    <td><button type="button" class="update half" onclick="location.href='q6-update-sub.php'">更新</button></td>
                                </tr>
                            </table>
                            <h2>サブカテゴリー</h2>
