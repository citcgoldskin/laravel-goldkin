...
@section('content')
    <div id="contents">
        ...
        {{ Form::open(["route"=>"admin.freq.category.add_category", "method"=>"post", "name"=>"frm_add_category", "id"=>"frm_add_category"]) }}
                ...
                <div id="main-contents">
                    <div class="search-result-area">
                        ...
                        <ul class="btn-list mt0">
                            ...
                            @endforeach
                            <li>
                                <input type="text" placeholder="新しいカテゴリー名を入力" name="category_name" class="new-text" value="{{ old('category_name') }}">
                            </li>
                                @error('category_name')
                        ...
                        <button type="reset" class="cancel2" onclick="location.href='{{ route('admin.freq.category.index') }}'">キャンセル</button>
                    </div>
                </div>
            </section>
