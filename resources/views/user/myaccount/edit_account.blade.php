            ...
            <ul class="form_area">
                ...
                <li>
                    ...
                    <div class="form_wrap shadow-glay">
                        <input type="text" value="123" placeholder="">
                    </div>
                </li>
                ...
                <li>
                    <h3>口座番号</h3>
                    <div class="form_wrap shadow-glay">
                        <input type="text" value="1234567" placeholder="">
                    </div>
                ...
                <li>
                    <h3>口座名義（カナ）</h3>
                    <div class="form_wrap shadow-glay">
                        <input type="text" value="タナカタロウ" placeholder="">
                    </div>
                </li>
            </ul>
        ...
        <div class="white-bk pt20">
            ...
            <div class="button-area mt30">
                <div class="btn_base btn_orange shadow ">
                    <button type="submit" class="btn-send">変更する</button>
                </div>
            </div>
...
<div class="modal-wrap completion_wrap">
    <div id="modal-mail_henkou" class="modal-content">
        ...
        <div class="button-area type_under">
            <div class="btn_base btn_ok"><a id="modal-close" href="">OK</a></div>
        </div>
