...
@section('title', '運転免許証／履歴証明書の提出')

@section('content')
@include('user.layouts.header_under')
<div id="contents">
        {{ Form::open(["route"=>"user.myaccount.confirm_drive_put", "method"=>"put", "name"=>"form1", "id"=>"form1", "files"=>true ]) }}
        <input type="hidden" name="pc_confirm_type" value="{{ config('const.person_confirm_type_code.driver_license') }}">
        <section id="coupon_msg">

            <h3>
                運転免許証／運転経歴証明書の画像は<br>
                表面のみ提出をお願いします。
            </h3>
        ...
        <section id="example">
            ...
            <div class="inner_box">
                <div class="white_box">
                    <h3>○ 正しい例</h3>
                    <ul class="ex_correct">
                        <li><img src="{{ asset('assets/user/img/coupon/license/img_correct.png') }}" alt="正しい例"></li>
                        <li>
                            <p>画像が鮮明。</p>
            ...
            <div class="inner_box">
                <div class="white_box">
                    <h3>× 誤った例</h3>
                    <ul class="ex_error">
                        <li><img src="{{ asset('assets/user/img/coupon/license/img_error.png') }}" alt="誤った例"></li>
                        <li>
                            <p>画像が不鮮明。</p>
                            <p>必要項目が写っていない。</p>
                            <p>有効期限が切れている。</p>
        ...
        <section id="preparation" class="pb0">
