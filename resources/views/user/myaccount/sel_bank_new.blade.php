            ...
            <div class="inner_box">
                ...
                @for($i = 0; $i < 35; $i += 5)
                    <div class="board_box set-list_wrap">
                        ...
                        <div class="acd-content set-list_content">
                            <ul>
                                @for($j = $i; $j < $i + 5; $j++)
                                    <li><a href="{{ route('user.myaccount.sel_bank_alphabet', ['condition' => $condition, 'alpha' => config('const.alphabet.' . $j), 'prefix' => $alphabet_arr[$i]]) }}">{{$alphabet_arr[$j]}}</a></li>
                                @endfor
                            </ul>
                        </div>
                    </div>
                ...
                <div class="board_box set-list_wrap">
                    ...
                    <div class="acd-content set-list_content">
                        <ul>
                            @for($j = 35; $j < 38; $j++)
                                <li><a href="{{ route('user.myaccount.sel_bank_alphabet', ['condition' => $condition, 'alpha_id' => $j, 'prefix' => $alphabet_arr[35]]) }}">{{$alphabet_arr[$j]}}</a></li>
                            @endfor
                        </ul>
                    </div>
                </div>
                ...
                <div class="board_box set-list_wrap">
                    ...
                    <div class="acd-content set-list_content">
                        <ul>
                            <li><a href="{{ route('user.myaccount.sel_bank_alphabet', ['condition' => $condition, 'alpha_id' => 38, 'prefix' => $alphabet_arr[38]]) }}">{{$alphabet_arr[38]}}</a></li>
                        </ul>
                    </div>
                </div>
