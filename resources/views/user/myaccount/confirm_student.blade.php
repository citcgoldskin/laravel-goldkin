...
<div id="contents">
    ...
    <input type="hidden" name="pc_confirm_type" value="{{ config('const.person_confirm_type_code.student_card') }}">
        ...
        <section id="example">
            ...
            <div class="inner_box">
                <div class="white_box">
                    <h3>○ 正しい例</h3>
                    <ul class="ex_correct">
                        <li><img src="{{ asset('assets/user/img/coupon/student/img_correct.png') }}" alt="正しい例"></li>
                        <li>
                            <p>画像が鮮明。</p>
            ...
            <div class="inner_box">
                <div class="white_box">
                    <h3>× 誤った例</h3>
                    <ul class="ex_error">
                        <li><img src="{{ asset('assets/user/img/coupon/student/img_error.png') }}" alt="誤った例"></li>
                        <li>
                            <p>画像が不鮮明。</p>
                            <p>必要項目が写っていない。</p>
                            <p>有効期限が切れている。</p>
