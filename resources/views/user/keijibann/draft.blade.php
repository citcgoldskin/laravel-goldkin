...
@include('user.layouts.gnavi_under')
    <div id="contents">
        ...
        <div class="tabs info_wrap three_tab nomt">
            ...
            <input id="tab-02" type="radio" name="tab_item"  checked="checked" onclick="location.href='{{route("keijibann.draft")}}/1'">
            ...
            <div class="tab_content" id="tab_content">
                <section>
                    ...
                    <div class="board_box">
                        <a href="{{route('keijibann.recruiting_edit'). '/' . $val['rc_id']}}">
                            <ul class="info_ttl_wrap">
                                <li>
                                    <img src="{{ isset($val['cruitLesson']) ?  \App\Service\CommonService::getLessonClassIconUrl($val['cruitLesson']['class_icon']) : '' }}" alt="">
                                </li>
                                <li>
    ...
    <script>
        ...
        function getMoreRecruits()
        {
            ...
            $.ajax({
                type: "get",
                url: "{{route('keijibann.draft')}}" + "/2" + "?page=" + pageCurrent,
                dataType: 'json',
                contentType: false,
                processData : false,
