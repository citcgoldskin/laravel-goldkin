    ...
    <div id="contents" class="short">
        ...
        <section id="talkroom_menu">
            ...
            <div class="tabs info_wrap mt0">
                <input id="tab-01" type="radio" name="tab_item" {{ $type==config('const.menu_type.kouhai') ? 'checked="checked"':''}}>
                <label class="tab_item" for="tab-01">コウハイメニュー</label>
                <input id="tab-02" type="radio" name="tab_item" {{ $type==config('const.menu_type.senpai') ? 'checked="checked"':''}}>
