    ...
    ************************************************************************* -->
    ...
    <div id="contents">
        ...
        <section class="tab_area tab_white mb0">
            <div class="switch_tab three_tab">
                <div class="type_radio radio-01">
                    <input type="radio" name="onof-line" id="off-line">
                    <label class="ok" for="off-line">出品レッスン</label>
                </div>
                <div class="type_radio radio-02">
                    <input type="radio" name="onof-line" id="on-line-1">
        ...
        <div class="tabs info_wrap mt0">
            <input id="tab-01" type="radio" name="tab_item">
            <label class="tab_item" for="tab-01">
                予約リクエスト<span class="midoku">7</span>
            </label>
            <input id="tab-02" type="radio" name="tab_item" checked="checked">
                    ...
                    <div class="board_box">
                        <a href="C-22_23.php">
                            <ul class="teacher_info_03 mt0">
                                <li class="icon_s40"><img src="img/icon_photo_02.png" class="プロフィールアイコン"></li>
                                <li class="about_teacher">
                                    <div class="profile_name">
                                        <p>まゆゆゆゆゆゆゆゆゆゆ<br><span>（22）女性</span></p>
                                    </div>
                                </li>
                                <li class="icon_s40"><img src="img/icon_lesson_ttl_01.png" class="カテゴリーアイコン"></li>
                            </ul>
                            ...
                            <div class="kigen_wrap">
                                ...
                                <ul class="list_area">
                                    <li>
                                        <div>1月20日　20:00~21:00</div>
                                        <div>2,000円</div>
                                    </li>
                                    <li>
                                        <div>1月21日　19:00~19:45</div>
                                        <div>1,500円</div>
                                    </li>
                                    <li>
                                        <time class="icon-time">60~120分 /2,000~4,000円</time>
                                    </li>
                                </ul>
                        </a>
                    </div>
            ...
            <div class="board_box">
                <a href="C-22_23.php">
                    <ul class="teacher_info_03 mt0">
                        <li class="icon_s40"><img src="img/icon_02.svg" class="プロフィールアイコン"></li>
                        <li class="about_teacher">
                            <div class="profile_name">
    ...
    <div class="tab_content" id="tab-02_content">
        <section>
            ...
            <div class="board_box">
                <a href="C-26.php">
                    <ul class="teacher_info_03 mt0">
                        <li class="icon_s40"><img src="img/icon_teacher_04.png" class="プロフィールアイコン"></li>
                        <li class="about_teacher">
                            <div class="profile_name">
    ...
    <div class="board_box">
        <a href="C-26.php">
            <ul class="teacher_info_03 mt0">
                <li class="icon_s40"><img src="img/icon_02.png" class="プロフィールアイコン"></li>
                <li class="about_teacher">
                    <div class="profile_name">
