    ...
    ************************************************************************* -->
    ...
    <div id="contents" class="short">
        ...
        <form action="" method="post" name="form1" id="form1" target="senddata">
            ...
            <section class="tab_area tab_white hide">
                <h3>レッスン形式</h3>
                ...
                <div class="switch_tab">
                    ...
                    <div class="radio-02">
                        <input type="radio" name="onof-line" id="on-line" value="C-10-1.php"
                ...
                <div class="inner_box">
                    ...
                    <div class="white_box">
                        ...
                        <div class="input-text2">
                            <textarea placeholder="待ち合わせ場所の詳細を入力してください。" maxlength="100"
                                      class="shadow-glay count-text100"></textarea>
            ...
            <section id="f-white_area">
                <div class="button-area mt20">
                    <div class="btn_base btn_orange shadow">
                        <button type="submit" class="btn-send">出品を申請する</buton>
                    </div>
                    <div class="btn_base btn_pale-gray shadow">
                        <button type="button" class="modal-syncer button-link" data-target="modal-shitagaki">下書きに保存
                        </button>
                    </div>
                ...
                <div class="modal_body">
                    ...
                    <div class="button-area mt50">
                        <div class="btn_base btn_orange">
                            <button type="button" onclick="location.href='C12_2.php'">削除</button>
                        </div>
            ...
            <div class="modal-wrap completion_wrap">
                <div id="modal-listing" class="modal-content">
                    ...
                    <div class="button-area">
                        ...
                        <!--
                  <div class="btn_base btn_gray-line">
                  <a href="B-12_2.php">続けてオンライン型を出品</a>
                 </div>
-->
                    </div>
                </div>
