    ...
    ************************************************************************* -->
           ...
           <section id="f-white_area">
            <div class="button-area mt20">
              ...
              <div class="btn_base btn_pale-gray shadow">
               <button type="button" class="modal-syncer button-link" data-target="modal-shitagaki">下書きに保存</button>
              </div>
    ...
    よろしいですか？
                     ...
                     <div class="button-area mt50">
                         ...
                         <button type="button" onclick="location.href='C-12..php'">削除</button>
                         </div>
                     ...
                     <div class="button-area">
                         <div class="btn_base btn_orange">
                          <a href="C-3_4.php">OK</a>
                                                            ...
                                                            <!--
                         <div class="btn_base btn_gray-line">
                          <a href="B-12.php">続けてオンライン型を出品</a>
                         </div>
    -->
                    </div>
                </div>
