...
class CommonAlertRequest extends FormRequest
{
    protected $_request;
    ...
    public function attributes()
    {
        ...
        $attributes['alert_title']  = "タイトル";
        $attributes['alert_text'] = "本文";
        return $attributes;
    }
    ...
    {
        return [
            'alert_title.required' => 'タイトルを入力してください。',
            'alert_text.required' => '本文を入力してください。'
        ];
    }
}
